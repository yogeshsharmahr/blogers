            ...
            <div class="col-md-8 animate-box" data-animate-effect="fadeInLeft">
                ...
                <div class="row pb-4">
                    ...
                    <div class="col-md-7 animate-box">
                        <a href="{{ route('single.post', $posts->slug) }}" class="fh5co_magna py-2">{{ $posts->title }}</a> <br><a href="#" class="fh5co_mini_time py-3"> {{ $posts->categories }} </a><br>
                        <a href="#" class="fh5co_mini_time py-3"> Thomson Smith -
                        April 18,2016 </a>
                        <div class="fh5co_consectetur"> {{ $posts->body }}
                        </div>
                    </div>
                </div>
                @endforeach
