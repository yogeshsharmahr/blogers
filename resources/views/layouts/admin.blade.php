                    ...
                    <ul class="nav nav-sidebar-menu sidebar-toggle-view">
                        ...
                        <li class="nav-item">
                            <a href="{{route('posts.index')}}" class="nav-link"><i
                                    class="flaticon-open-book"></i><span>All Post</span></a>
                        </li>
                        <li class="nav-item">
                            <a href="{{route('add.post')}}" class="nav-link"><i class="flaticon-upload"></i><span>Add
                                    Post</span></a>
                        </li>
                       
                        
                        <li class="nav-item">
                            <a href="{{route('all.video')}}" class="nav-link"><i
                                    class="flaticon-open-book"></i><span>All Videos</span></a>
                        </li>
